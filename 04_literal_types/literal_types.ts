...
// The process of going from an infinite number of potential cases (there are an infinite
// number of possible string values) to a smaller, finite number of potential case
...
// =====================
// TypeScript also has boolean literal types. You might use these to constrain
// object values whose properties are interrelated.
